...
export default function NewCustomerPage() {
  ...
  async function handleSubmit(e: { preventDefault(): void }) {
    ...
    if (res.ok) {
      ...
      setError(err.error?.fieldErrors ? JSON.stringify(err.error.fieldErrors) : "Failed to save customer");
    }
  }
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                  <div>
                    ...
                    <Input value={form.code} onChange={(e) => set("code", e.target.value)} required className="mt-1" placeholder="CUS-001" />
                  </div>
                  <div>
