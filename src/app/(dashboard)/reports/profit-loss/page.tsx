    ...
    <div className="flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        <form className="flex gap-3 items-end">
          <div><label className="text-xs font-medium text-gray-500">From</label>
          ...
          <div><label className="text-xs font-medium text-gray-500">To</label>
        ...
        <div className="mx-auto max-w-xl rounded-lg border bg-white shadow-sm overflow-hidden">
          <div className="bg-gray-900 text-white px-6 py-4">
            <h2 className="text-lg font-bold">Profit & Loss Statement</h2>
            <p className="text-xs text-gray-300 mt-0.5">
              {from.toLocaleDateString("en-PK", { day: "2-digit", month: "short", year: "numeric" })} — {to.toLocaleDateString("en-PK", { day: "2-digit", month: "short", year: "numeric" })}
            </p>
          </div>
          ...
          <table className="w-full text-sm">
            <tbody>
              <tr className="bg-blue-50">
                <td className="px-6 py-3 font-bold text-blue-900">INCOME</td><td />
              </tr>
              ...
              <tr className="bg-red-50">
                <td className="px-6 py-3 font-bold text-red-900">COST OF GOODS SOLD</td><td />
              </tr>
              <tr className="border-b">
              ...
              <tr className="bg-orange-50">
                <td className="px-6 py-3 font-bold text-orange-900">OPERATING EXPENSES</td><td />
              </tr>
              ...
              <tr className={`${netProfit >= 0 ? "bg-green-50" : "bg-red-50"}`}>
                <td className="px-6 py-4 font-bold text-lg text-gray-900">NET {netProfit >= 0 ? "PROFIT" : "LOSS"}</td>
                <td className={`px-6 py-4 text-right font-bold text-xl ${netProfit >= 0 ? "text-green-700" : "text-red-700"}`}>
